"""Run Marker on one real document.

Install the optional dependency first:
    pip install -e '.[marker]'

When picture descriptions are enabled, also start the local vLLM server as
described in docs/marker.md.
"""
